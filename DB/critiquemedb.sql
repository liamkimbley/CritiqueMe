...
INSERT INTO `profile` (`id`, `first_name`, `last_name`, `bio`, `location_id`, `user_id`, `image`) VALUES (7, 'Marty', 'Byrde', 'Investor. Lake experience owner. Come check it out.', 4, 7, 'https://static.wikia.nocookie.net/2a6c845c-c6e9-472e-abed-24863817b795/scale-to-width/300');
...
INSERT INTO `profile` (`id`, `first_name`, `last_name`, `bio`, `location_id`, `user_id`, `image`) VALUES (1, 'Greg', 'Lewis', 'I love piano, goats, and hockey', 4, 1, 'https://media.licdn.com/dms/image/C4E03AQF1fuQAJ-ZO1A/profile-displayphoto-shrink_200_200/0?e=1543449600&v=beta&t=oU_wPn47_XfboHrZXdmSFZ6HfA6NmRGaV8l0BSeV-MY');
...
START TRANSACTION;
USE `critiquemedb`;
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (7, 5, DEFAULT, DEFAULT, 'I really enjoy classical music so I made this compilation of my favorite works from Beethoven. My favorite track is Symphony No. 3 \"Eroica\" because of the robust woodwind solo. Please listen to it and share what you all think.', 'My New Album', 'https://images-na.ssl-images-amazon.com/images/I/51aPPEV-AjL.jpg');
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (11, 6, DEFAULT, DEFAULT, 'my name is jeff', 'hello', 'https://www.youtube.com/watch?v=AfIOBLr1NDU');
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (9, 7, DEFAULT, DEFAULT, 'Do any investors have some feedback on my portfolio? My returns are good but I\'m worried about its perfomance going forward.', 'My Portfolio', 'https://www.alhambrapartners.com/wp-content/uploads/2012/07/WA.png');
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (8, 8, DEFAULT, DEFAULT, 'I just bought this carwash recently. I\'ve put a lot of work into the layout. Any feedback is welcomed.', 'A1 Car Wash', 'https://www.breakingbad-locations.com/wp-content/uploads/2014/09/E07-Problem-Dog.mkv_000823371.jpg');
...
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (3, 10, DEFAULT, DEFAULT, 'I\'m hoping to get more business for my law firm. Does anyone find this commercial appealing?', 'New Commercial', 'https://www.youtube.com/watch?v=pPd67CEL54E');
...
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (4, 2, DEFAULT, DEFAULT, 'What\'s up guys. Check out my new cover. Thx', 'Believer Guitar Cover', 'https://www.youtube.com/watch?v=hXQxSi34GWY');
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (5, 3, DEFAULT, DEFAULT, 'How cool does this interior design look??', 'New Style Design!!', 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/ed-best-decor-santa-monica3-1520362749.jpg?crop=1xw:1xh;center,top&resize=480:*');
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (6, 12, DEFAULT, DEFAULT, 'These guys did an awesome job on this site. Thoughts?', 'Trail Mixer', 'http://18.216.51.206:8080/MVCTrailMixer/');
INSERT INTO `post` (`id`, `profile_id`, `create_date`, `update_date`, `content`, `title`, `media`) VALUES (2, 12, DEFAULT, DEFAULT, 'Hello. I made a Blackjack app in byte code. Are there any developers out there who can tell me how this looks? ', 'Blackjack Game', 'https://www.desktopbackground.org/download/o/2015/10/14/1026270_matrix-binary-code-wallpapers_1920x1080_h.jpg');
...
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (3, 7);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (3, 6);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (4, 20);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (5, 3);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (5, 12);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (5, 16);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (6, 11);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (6, 12);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (6, 4);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (7, 20);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (8, 7);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (9, 8);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (9, 7);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (10, 7);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (10, 5);
INSERT INTO `post_category` (`post_id`, `category_id`) VALUES (11, 19);
...
START TRANSACTION;
USE `critiquemedb`;
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (1, 'Hello, mike. I find the the woodwind solo to be exuberant and very stimulating. A nicely put together album indeed.', DEFAULT, DEFAULT, 7, 7);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (3, 'I think it looks pretty good. I have a guy who manages my portfolio. He might be able to help.', DEFAULT, DEFAULT, 8, 9);
...
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (5, 'I really enjoyed the performance. Very nice.', DEFAULT, DEFAULT, 8, 1);
...
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (7, 'I found myself singing along! Lol', DEFAULT, DEFAULT, 3, 4);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (8, 'jeff', DEFAULT, DEFAULT, 6, 5);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (9, 'jeff', DEFAULT, DEFAULT, 6, 6);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (10, 'Hi John, your code looks pretty good overall. The only thing I would suggest is to use more descriptive variable names and remember to comment your code. Good work though.', DEFAULT, DEFAULT, 11, 2);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (12, 'Good looking commercial. I\'m sure it will be a hit!', DEFAULT, DEFAULT, 8, 3);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (13, 'This is embarrassing ', DEFAULT, DEFAULT, 9, 3);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (14, 'Nice design Ellie. My wife might be interested in this.', DEFAULT, DEFAULT, 8, 5);
INSERT INTO `comment` (`id`, `content`, `created_at`, `updated_at`, `profile_id`, `post_id`) VALUES (15, 'Delicious restaurant! A great place to get lunch!', DEFAULT, DEFAULT, 10, 10);
